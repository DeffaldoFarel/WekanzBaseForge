...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center gap-1 rounded-full bg-slate-100 p-1 text-muted-foreground border border-border",
      className
    )}
    {...props}
  />
